<%@ Page Title="Bienvenida" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Bienvenida.aspx.cs"
    ResponseEncoding="utf-8" Inherits="Bienvenida" %>
                ...
                <div class="g-inner">
                    ...
                    <div class="g-success-alert">
                        ...
                        <p class="g-success-message">
                            Se logeo el
                            <asp:Label runat="server" ID="lblRol" CssClass="g-highlight" />
